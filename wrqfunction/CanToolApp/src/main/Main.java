 	...
 	private void initialize(){
			...
			public void mouseClicked(MouseEvent e) {
				...
				for(int i=0;i<signalList.size();i++){
					for(int j=0;j<strlist.size();j++){
						if(signalList.get(i).SignalName==strlist.get(j)&&signalList.get(i).MessageId==id){
		...
		*/
		...
		btnNewButton_2.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				File file1=new File("G://Java/Documents/CanToolApp/src/CANMessageJSON.json");
				FileWriter fw1;
				try {
				...
				File file2=new File("G://Java/Documents/CanToolApp/src/CANSignalJSON.json");
				FileWriter fw2;
				try {
		...
		btnNewButton_2.setBounds(846, 89, 113, 34);
		frmCantoolapp.getContentPane().add(btnNewButton_2);
